...
#function to download images from url and store in media folder
...
for k, group_id in enumerate(group_ids, 1):
    ...
    #For initilizing group fixtures
    payload = {
    ...
    for i, photo_id in enumerate(photo_ids["photos"]["photo"], 1):
        ...
        #get image details from each image_id
        payload = {
        ...
        group_image.append({"model": "apis.groupimage", "pk": imageCount, "fields": {"group": k, "image": imageCount}})

        #generate group_image fixtures
